                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="title" placeholder="Please enter product name" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="description" placeholder="Please enter description">
                                </div>
                            </div>
                        </div>
                        <div class="form-row m-b-55">
